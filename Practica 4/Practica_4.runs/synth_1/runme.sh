...
HD_PWD='C:/Users/jsanc/Desktop/Semestre/Arquitectura/Practica_4/Practica_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SumadorCascada.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SumadorCascada.tcl
