...
HD_PWD='C:/Users/jsanc/Desktop/Semestre/Arquitectura/Practica 5/Practica 5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SumRapido.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SumRapido.tcl
